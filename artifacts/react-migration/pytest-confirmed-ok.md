...
| `python tools\sync_packaging_files.py --check`; `python scripts\validate_openapi.py docs\openapi.yaml`; `git diff --cached --check` | OK | Packaging sincronizzato, OpenAPI valido e nessun errore whitespace sui file staged. |
