...
const requiredFiles = [
  ...
  'src/features/legal-skills/pages/PromptPathwaysPage.tsx',
  'src/features/legal-skills/components/FascicoloPicker.tsx',
...
for (const route of ['/legal-skills', '/legal-skills/profile', '/legal-skills/profile/cold-start', '/legal-skills/run', '/legal-skills/review-queue', '/legal-skills/runs', '/legal-skills/prompt', '/legal-skills/percorsi']) {
...
for (const component of ['PracticeProfilePage', 'ColdStartInterviewPage', 'LegalSkillRunPage', 'SkillRunDetailPage', 'ReviewerQueuePage', 'PromptLibraryPage', 'PromptPathwaysPage']) {
