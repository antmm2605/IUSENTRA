...
- se esistono account globali anomali non `SUPERADMIN`, il pannello `admin/utenti-piattaforma` consente di spostarli davvero dentro uno studio preservando credenziali, audit e ruolo tenant-aware
