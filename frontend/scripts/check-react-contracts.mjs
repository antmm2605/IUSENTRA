...
assertContains(viteConfig, 'cssCodeSplit: false', 'build React evita chunk CSS che reimportano l entry di bootstrap')
assertContains(viteConfig, 'inlineDynamicImports: true', 'entry React autosufficiente senza import ESM secondari nel primo caricamento')
assertNotContains(viteConfig, 'manualChunks(', 'entry React inline non deve dipendere da vendor chunk separati')
