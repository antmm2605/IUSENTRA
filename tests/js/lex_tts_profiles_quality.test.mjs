...
assert.equal(presets.getQualityPreset('fast').totalStep, 4)
assert.equal(presets.getQualityPreset('balanced').maxChunkChars, 280)
assert.equal(presets.getQualityPreset('high').speed, 0.96)
...
assert.equal(readingHigh.totalStep, 12)
