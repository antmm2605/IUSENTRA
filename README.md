...
- Nel preventivo guidato le fasi tabellari restano visibili anche quando la regola usa `Compenso unico`: il flag unico e' aggiuntivo, attivo valorizza la voce unica e disattivo calcola le fasi selezionate; la complessita stimata bassa/media/alta usa la stessa colonna minimo/base/massimo del tariffario reale della pratica, con spese generali e bonus telematico allineati; la clausola controversie resta una sola sezione modificabile e trasferibile al conferimento.
