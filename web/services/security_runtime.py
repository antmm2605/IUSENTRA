...
_CSRF_PROTECTED_ENDPOINTS = {
    ...
    "api_v1_react.sito_studio_articolo_modifica_salva",
    ...
    "api_v1_client_portal.studio_settings_update",
    "api_v1_client_portal.studio_invite_create",
    "api_v1_client_portal.studio_invite_revoke",
    "api_v1_client_portal.studio_message_create",
    "api_v1_client_portal.studio_document_request_create",
    "api_v1_client_portal.studio_signature_request_create",
    "api_v1_client_portal.studio_appointment_create",
    "api_v1_client_portal.studio_evidence_pack_create",
    "api_v1_client_portal.public_invite_accept",
    "api_v1_client_portal.public_profile_update",
    "api_v1_client_portal.public_preferences_update",
    "api_v1_client_portal.public_consent_update",
    "api_v1_client_portal.public_message_create",
    "api_v1_client_portal.public_document_upload",
    "api_v1_client_portal.public_signature_complete",
    "api_v1_client_portal.public_appointment_update",
