...
_GENERIC_OPERATION_CATALOG: dict[str, list[tuple[str, str, str, list[tuple[str, str, str]]]]] = {
    ...
    "ricerca-legale": [
        ("cruscotto-ricerca", "Cruscotto ricerca", "Apre monitor normativo e Ricerca legale.", [("Apri ricerca", "/ricerca-legale", "GET")]),
        ("news-legali", "News legali", "Consulta aggiornamenti e filtri per materia.", [("Apri news", "/ricerca-legale/news", "GET")]),
        ("registro-mediazione", "Registro mediazione", "Apre dati e aggiornamenti sulla mediazione.", [("Apri registro", "/ricerca-legale/mediazione", "GET")]),
    ],
    "giurisprudenza": [
    ...
    "strumenti-forensi": [
        ...
        ("capitalizzazione-rendita", "Capitalizzazione di una rendita", "Attualizza il reddito perduto con i coefficienti Milano 2024.", [("Calcola capitale", "/strumenti-legali/?tool=capitalizzazione_rendita", "GET")]),
        ("danno-biologico", "Danno biologico", "Tabelle vigenti: art. 139 cod. ass., D.P.R. 12/2025 e Milano 2024.", [("Calcola danno", "/strumenti-legali/?tool=danno_biologico", "GET")]),
        ...
        ("mediazione", "Mediazione", "Apre registro e riferimenti utili per costi e organismi.", [("Apri mediazione", "/ricerca-legale/mediazione", "GET")]),
    ...
    "strumenti-operativi": [
        ...
        ("regia-operativa", "Controllo Studio", "Rientra nel quadro operativo dello studio.", [("Apri controllo", "/workspace-intelligente", "GET")]),
