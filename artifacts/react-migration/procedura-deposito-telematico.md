...
- Fix sicurezza `2.253.59`: i payload di deposito React/legacy, database admin e apertura fascicolo da preventivo/conferimento passano da redazione pubblica; la cache/report `.cer` usa solo nomi file normalizzati dentro la directory prevista; la nota firma visibile non usa più regex fragile e non taglia note multilinea dell'utente.
