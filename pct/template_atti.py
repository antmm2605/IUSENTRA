...
from pct.catalogo_caratteri import EDITOR_FONT_CATALOG as _CATALOGO_CARATTERI
...
#: Il catalogo vive in un modulo senza dipendenze: vedi pct/catalogo_caratteri.py.
EDITOR_FONT_CATALOG = _CATALOGO_CARATTERI
