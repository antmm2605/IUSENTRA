...
| `python -m pytest -q tests/test_procedure_inventory_importer.py tests/test_procedure_xsd_mapper.py tests/test_procedure_source_research.py tests/test_procedure_knowledge_pipeline.py tests/test_procedure_lifecycle.py tests/test_digital_signature_workflow.py tests/test_telematic_deposit_workflow.py tests/test_post_acceptance_obligations.py tests/test_notification_workflow.py tests/test_evidence_vault.py tests/test_procedure_coverage_ext.py tests/test_procedure_lifecycle_repository.py tests/test_procedure_lifecycle_edges.py` | OK | 32/32 passati: migration idempotente, CLI dry-run/apply, import XSD con/senza children, mapping prefissi, fonte anti-copia, privacy flag, schede, transizioni bloccanti, firma, deposito, ricevute, obblighi, notifica, evidence, audit sanificato, tenant columns, gap queue e trigger anti-bypass SQL. |
