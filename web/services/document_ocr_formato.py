...
from legal_ocr.page_layout import Blocco
...
ALLINEAMENTI = (ALLINEAMENTO_SINISTRA, ALLINEAMENTO_CENTRO, ALLINEAMENTO_DESTRA)
...
def _allineamento(parole: Sequence[dict[str, Any]], misure: Misure) -> str:
    ...
    return max(ALLINEAMENTI, key=lambda voce: (conteggio.get(voce, 0), voce == ALLINEAMENTO_SINISTRA))
