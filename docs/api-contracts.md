...
- Endpoint P0/P1 con contratto OpenAPI: 293.
...
- Endpoint con provider verification 401 reale o errore pubblico sicuro: 345.
- Endpoint pubblici Portale Cliente verificati senza token valido: 24.
