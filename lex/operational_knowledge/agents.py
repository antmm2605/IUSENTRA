...
DEFAULT_OPERATIONAL_AGENTS: tuple[OperationalAgentDefinition, ...] = (
    ...
    OperationalAgentDefinition(
        ...
        "Email PEC",
        "comunicazioni",
        ("email_pec", "messaggi", "fascicoli"),
        ("list_pec_messages", "get_pec_message", "list_pec_attachments"),
    ...
    OperationalAgentDefinition(
        ...
        "telematico",
        ("telematico", "uffici_giudiziari", "email_pec", "pdf_manager", "firma_digitale"),
        ("get_telematico_status", "lookup_uffici_giudiziari", "list_pec_messages"),
