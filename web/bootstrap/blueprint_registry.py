...
BLUEPRINT_REGISTRY: tuple[BlueprintRegistration, ...] = (
    ...
    BlueprintRegistration(
        "api_v1_amministrativo",
        "web.blueprints.api_v1_amministrativo",
        "api_v1_amministrativo",
        "/api/v1/ui/amministrativo",
    ),
    BlueprintRegistration(
        "api_v1_tributario",
        "web.blueprints.api_v1_tributario",
        "api_v1_tributario",
        "/api/v1/ui/tributario",
    ),
    BlueprintRegistration(
    ...
    BlueprintRegistration(
        "api_v1_prompt_pathways",
        "web.blueprints.api_v1_prompt_pathways",
        "api_v1_prompt_pathways",
        "/api/v1/legal-skills/prompt-library/percorsi",
    ),
