...
assertContains(mainEntrypoint, "await import('./app/App')", 'entrypoint React carica l’app operativa dopo il bootstrap minimo')
assertContains(mainEntrypoint, "await import('./components/SupportOperatorRoom')", 'entrypoint React carica supporto remoto dopo il bootstrap minimo')
