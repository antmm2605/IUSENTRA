...
export const studioModules: StudioModuleConfig[] = [
  {
    ...
    cards: [
      { title: 'Dati studio', body: 'Anagrafica, titolare, recapiti, albo, coordinate e dati usati in atti, parcelle e depositi.', href: '/impostazioni-studio', action: 'Apri dati studio', icon: 'building', tone: 'primary', meta: 'Impostazioni' },
      { title: 'Comunicazioni', body: 'Configura PEC, posta ordinaria, SMTP e canali WhatsApp senza perdere il presidio locale.', href: '/impostazioni-studio', action: 'Apri canali', icon: 'mail', tone: 'success', meta: 'PEC / SMTP' },
  ...
  },
  {
    ...
    cards: [
      { title: 'Acquisizione PST', body: 'Apri il presidio React del flusso PolisWeb / PST e verifica i passaggi prima dell import.', href: '/portali/pst/acquisizione', action: 'Apri presidio', icon: 'upload', tone: 'primary', meta: 'React' },
      { title: 'Checklist import PST', body: 'Controlla prerequisiti, mapping fascicolo e documenti prima di usare la vista tecnica.', href: '/portali/pst/acquisizione', action: 'Verifica flusso', icon: 'briefcase', tone: 'success', meta: 'Presidio' },
    ...
    links: [{ label: 'Panoramica PST', href: '/polisWeb' }, { label: 'Centro telematico', href: '/telematico' }, { label: 'Vista tecnica', href: legacy('/portali/pst/acquisizione') }],
  },
  {
    id: 'statistiche',
    routes: ['/statistiche'],
  ...
  },
  {
    ...
    cards: [
      ...
      { title: 'Configura WhatsApp', body: 'Gestisci credenziali e numeri provider nelle impostazioni studio.', href: '/impostazioni-studio', action: 'Apri configurazione', icon: 'settings', tone: 'primary', meta: 'Provider' },
  ...
  },
  {
    ...
    cards: [
      ...
      { title: 'Scheduler backup', body: 'Configura orario backup e promemoria automatici dello studio.', href: '/impostazioni-studio', action: 'Apri scheduler', icon: 'clock', tone: 'success', meta: 'Automazione' },
  ...
  },
  {
    ...
    cards: [
      { title: 'Dati studio', body: 'Apri dati anagrafici, fiscali e recapiti usati nei documenti.', href: '/impostazioni-studio', action: 'Apri studio', icon: 'building', tone: 'primary', meta: 'Anagrafica' },
      { title: 'PEC e SMTP', body: 'Verifica PEC, Local Signer e invio messaggi senza salvare password nel server.', href: '/impostazioni-studio', action: 'Apri PEC', icon: 'mail', tone: 'success', meta: 'Posta' },
      { title: 'Firma digitale', body: 'Controlla backend firma e canale Local Signer per token USB.', href: '/impostazioni-studio', action: 'Apri firma', icon: 'shield', tone: 'warning', meta: 'PKCS#11' },
      { title: 'AI locale', body: 'Configura runtime AI locale e reindicizzazione documenti.', href: '/impostazioni-studio', action: 'Apri AI', icon: 'spark', tone: 'purple', meta: 'Lex' },
    ],
