...
| Backend domain | Frontend/UI | tests/test_local_pec_runtime.py | happy/edge path dominio | nessun runner component/VRT dedicato; copertura via gate statici e browser smoke | censito |
