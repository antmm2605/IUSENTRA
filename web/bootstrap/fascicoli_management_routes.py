        ...
        if request.method == "POST":
            ...
            try:
                ...
                gf.aggiorna(
                    ...
                    ruolo_sezione=form.get("ruolo_sezione", "").strip(),
                    avvocato_controparte=form.get("avvocato_controparte", "").strip(),
                    numero_attori=int(form.get("numero_attori") or 0),
                    numero_convenuti=int(form.get("numero_convenuti") or 0),
                    qualifica_giudiziale_titolare=form.get("qualifica_giudiziale_titolare", "").strip(),
                    link_cartella_esterna=form.get("link_cartella_esterna", "").strip(),
                    nome_gruppo=form.get("nome_gruppo", "").strip(),
                    numero_cci=form.get("numero_cci", "").strip(),
                    ...
                    testo_personalizzabile_1=form.get("testo_personalizzabile_1", "").strip(),
                    testo_personalizzabile_2=form.get("testo_personalizzabile_2", "").strip(),
