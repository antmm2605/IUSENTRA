...
export const studioModules: StudioModuleConfig[] = [
  ...
  },
  {
    ...
    cards: [
      { title: 'Cruscotto ricerca', body: 'Apri monitor normativo e quadro Ricerca legale.', href: '/legal-intelligence/', action: 'Apri ricerca', icon: 'book', tone: 'primary', meta: 'Fonti' },
  ...
  },
  {
    ...
    cards: [
      ...
      { title: 'Mediazione', body: 'Apri registro e riferimenti utili per costi e organismi.', href: '/legal-intelligence/mediazione', action: 'Apri mediazione', icon: 'landmark', tone: 'success', meta: 'ADR' },
  ...
  },
  {
    ...
    kpis: [
      ...
      { label: 'Esportazioni', value: 'Pronte', note: 'dati riutilizzabili fuori piattaforma', tone: 'success' },
    ...
    cards: [
      ...
      { title: 'Database', body: 'Verifica archivi, integrità e manutenzione dei dati dello studio.', href: '/admin/database', action: 'Apri database', icon: 'database', tone: 'purple', meta: 'Archivi' },
      { title: 'Backup', body: 'Controlla copie, verifica e pianificazione nella scheda impostazioni.', href: '/impostazioni?tab=backup', action: 'Apri backup', icon: 'backup', tone: 'orange', meta: 'Continuità' },
    ...
    workflow: ['Apri strumento', 'Aggancia cliente o fascicolo', 'Completa azione', 'Verifica il registro se necessario'],
    links: [{ label: 'Agenda', href: '/agenda' }, { label: 'Messaggi', href: '/messaggi' }, { label: 'Backup', href: '/impostazioni?tab=backup' }],
  },
  {
    id: 'sito-studio',
