...
- Endpoint React API censiti: 309.
- Endpoint con `_richiedi_auth`: 309/309.
- Endpoint con metodo di scrittura o cancellazione: 162.
...
| `GET` | `/api/v1/ui/amministrazione/consistenza-dati` | Amministrazione | P0 | `utenti.leggi` | riepilogo governance studio | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
...
| `GET` | `/api/v1/ui/email/source/<message_id>` | Email PEC | P0 | `sessione/API tenant-aware` | messaggi, allegati e destinatari | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
...
| `GET` | `/api/v1/ui/fascicoli/<id_fasc>/audit` | Fascicoli e documenti | P0 | `sessione/API tenant-aware` | fascicoli, documenti e depositi | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/fascicoli/<id_fasc>/bonifico-ricevuto` | Fascicoli e documenti | P0 | `sessione/API tenant-aware` | fascicoli, documenti e depositi | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
...
| `POST` | `/api/v1/ui/fascicoli/<id_fasc>/deposito/classifica-documenti` | Fascicoli e documenti | P0 | `sessione/API tenant-aware` | fascicoli, documenti e depositi | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/fascicoli/<id_fasc>/deposito/valore-causa` | Fascicoli e documenti | P0 | `sessione/API tenant-aware` | fascicoli, documenti e depositi | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
...
| `GET` | `/api/v1/ui/fascicoli/<id_fasc>/lettura` | Fascicoli e documenti | P0 | `sessione/API tenant-aware` | fascicoli, documenti e depositi | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `GET` | `/api/v1/ui/fascicoli/<id_fasc>/letture` | Fascicoli e documenti | P0 | `sessione/API tenant-aware` | fascicoli, documenti e depositi | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/fascicoli/<id_fasc>/letture/aggiorna` | Fascicoli e documenti | P0 | `sessione/API tenant-aware` | fascicoli, documenti e depositi | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/fascicoli/<id_fasc>/letture/anomalie/<anomalia_id>` | Fascicoli e documenti | P0 | `sessione/API tenant-aware` | fascicoli, documenti e depositi | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
...
| `GET` | `/api/v1/ui/fascicoli/preferenze-filtri` | Fascicoli e documenti | P0 | `sessione/API tenant-aware` | fascicoli, documenti e depositi | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/fascicoli/preferenze-filtri` | Fascicoli e documenti | P0 | `sessione/API tenant-aware` | fascicoli, documenti e depositi | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `GET` | `/api/v1/ui/fascicoli/preferenze-vista-documenti` | Fascicoli e documenti | P0 | `sessione/API tenant-aware` | fascicoli, documenti e depositi | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/fascicoli/preferenze-vista-documenti` | Fascicoli e documenti | P0 | `sessione/API tenant-aware` | fascicoli, documenti e depositi | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/fascicoli/presidio-economico/proforme` | Fascicoli e documenti | P0 | `sessione/API tenant-aware` | fascicoli, documenti e depositi | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
...
| `POST` | `/api/v1/ui/fatturazione/<id_documento>/commercialista/email/invia` | Fatturazione | P0 | `fatturazione.leggi/scrivi` | parcelle, importi e PDF | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/fatturazione/<id_documento>/commercialista/pec/conferma` | Fatturazione | P0 | `fatturazione.leggi/scrivi` | parcelle, importi e PDF | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/fatturazione/<id_documento>/commercialista/prepara` | Fatturazione | P0 | `fatturazione.leggi/scrivi` | parcelle, importi e PDF | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/fatturazione/<id_documento>/dettaglio` | Fatturazione | P0 | `fatturazione.leggi/scrivi` | parcelle, importi e PDF | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/fatturazione/<id_documento>/sdi/esito` | Fatturazione | P0 | `fatturazione.leggi/scrivi` | parcelle, importi e PDF | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/fatturazione/<id_documento>/sdi/pec/conferma` | Fatturazione | P0 | `fatturazione.leggi/scrivi` | parcelle, importi e PDF | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/fatturazione/<id_documento>/sdi/pec/prepara` | Fatturazione | P0 | `fatturazione.leggi/scrivi` | parcelle, importi e PDF | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
...
| `POST` | `/api/v1/ui/fatturazione/<id_documento>/xml/firmato` | Fatturazione | P0 | `fatturazione.leggi/scrivi` | parcelle, importi e PDF | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/fatturazione/<id_documento>/xml/prepara-firma` | Fatturazione | P0 | `fatturazione.leggi/scrivi` | parcelle, importi e PDF | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
...
| `POST` | `/api/v1/ui/notifiche-legali/attestazione-conformita-fascicolo` | Notifiche legali | P1 | `sessione/API tenant-aware` | relate, destinatari e bozze | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/notifiche-legali/bozze-attestazione` | Notifiche legali | P1 | `sessione/API tenant-aware` | relate, destinatari e bozze | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
...
| `POST` | `/api/v1/ui/notifiche-legali/destinatari-manuali` | Notifiche legali | P1 | `sessione/API tenant-aware` | relate, destinatari e bozze | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/notifiche-legali/invio-pec-locale` | Notifiche legali | P1 | `sessione/API tenant-aware` | relate, destinatari e bozze | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/notifiche-legali/invio-pec-locale/conferma` | Notifiche legali | P1 | `sessione/API tenant-aware` | relate, destinatari e bozze | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
...
| `GET` | `/api/v1/ui/notiziario` | API React operativa | P2 | `sessione/API tenant-aware` | payload applicativo tenant-aware | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `PATCH` | `/api/v1/ui/notiziario/<news_id>/interazione` | API React operativa | P2 | `sessione/API tenant-aware` | payload applicativo tenant-aware | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/notiziario/aggiorna` | API React operativa | P2 | `sessione/API tenant-aware` | payload applicativo tenant-aware | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `GET` | `/api/v1/ui/notiziario/fonti/<source_id>` | API React operativa | P2 | `sessione/API tenant-aware` | payload applicativo tenant-aware | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
...
| `GET,POST` | `/api/v1/ui/pst/pagopa-proxy/` | API React operativa | P2 | `sessione/API tenant-aware` | payload applicativo tenant-aware | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `GET,POST` | `/api/v1/ui/pst/pagopa-proxy/<path:pst_path>` | API React operativa | P2 | `sessione/API tenant-aware` | payload applicativo tenant-aware | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
...
| `GET` | `/api/v1/ui/scadenziario/pdf-scadenze/anteprima` | Scadenziario | P1 | `sessione/API tenant-aware` | termini e audit calcolo | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
| `POST` | `/api/v1/ui/scadenziario/pdf-scadenze/importa` | Scadenziario | P1 | `sessione/API tenant-aware` | termini e audit calcolo | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
...
| `GET` | `/api/v1/ui/soggetti/registri-pubblici` | Soggetti e parti | P1 | `sessione/API tenant-aware` | anagrafiche parti | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
...
| `GET` | `/api/v1/ui/strumenti-legali` | API React operativa | P2 | `sessione/API tenant-aware` | payload applicativo tenant-aware | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
...
| `POST` | `/api/v1/ui/strumenti-legali/calcola` | API React operativa | P2 | `sessione/API tenant-aware` | payload applicativo tenant-aware | auth, tenant-aware, RBAC dominio, guardrail fase 5 |
