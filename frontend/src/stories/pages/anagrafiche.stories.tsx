...
import { ClientiCollaboratoriPage } from '../../components/ClientiCollaboratoriPage'
...
export const CollaboratoriCliente: Story = createPageStory({ sourcePath: 'src/components/ClientiCollaboratoriPage.tsx', title: 'Collaboratori del cliente', render: () => <ClientiCollaboratoriPage /> })
