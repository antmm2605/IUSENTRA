...
DEFAULT_SOURCE_DEFINITIONS: tuple[OperationalSourceDefinition, ...] = (
    ...
    _src(
        "economic_judgment",
        "Controllo economico sentenze",
        "economico",
        "economico",
        tenant_keys=("SENTENZA_ECONOMIC_DB",),
        permissions=("fatturazione.leggi",),
        repository_module="pct.sentenza_economic_repository.SentenzaEconomicRepository",
        api_surface="lex.tools.economic_context_tools.dispatch_tool",
        tools=(
        ...
        sensitive=True,
        notes="Read-only. Lex non deduce importi: legge solo audit/eventi verificati; si astiene se RG non combacia. Gated da lex.economicContextTools (default-off).",
    ),
    _src(
        "soggetti",
        "Soggetti e parti",
