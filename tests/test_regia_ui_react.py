...
def test_ui_notifiche_relata_firma_solo_con_prova_tecnica():
    ...
    assert "import { csrfToken } from '../formSubmit'" in source
...
def test_azioni_rapide_elenco_fascicoli_hanno_etichetta_e_target_tattile():
    ...
    assert "align-self:center!important;justify-self:center!important;margin-left:auto!important;margin-right:auto!important" in css
