...
REPORT = ROOT / "artifacts/react-migration/tranche-6a-gate.md"
...
def main() -> int:
    results: list[dict] = []
    with tempfile.TemporaryDirectory(prefix="iusentra-tranche-6a-", ignore_cleanup_errors=True) as tmp:
        tmp_path = Path(tmp)
        ...
        with app.test_client() as client:
            ...
            for path in ("/fatturazione", "/fatturazione/nuova", "/incassi-pagamenti"):
            ...
            for path in (
                ...
                "/fatturazione/qualunque",
                "/fatturazione/qualunque/pdf",
                "/fatturazione/qualunque/xml",
                "/incassi-pagamenti?_legacy=1",
                "/incassi-pagamenti/qualunque",
