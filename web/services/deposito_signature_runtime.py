...
def dati_atto_signature_gate(
    ...
    *,
    ...
    """Validate signed DatiAtto.xml or return the Local Signer handoff response."""
    ...
    if dati_atto_firmato_b64:
        try:
            ...
            return None, (
                jsonify({"ok": False, "errore": "DatiAtto.xml.p7m non valido: la firma ricevuta non è base64 corretto."}),
                400,
            )
    ...
    return None, redacted_json_response(
        {
            "ok": False,
