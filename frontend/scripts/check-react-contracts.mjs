...
assertContains(preventivoWizardPage, 'PRATICHE_COLLEGATE_CATALOG', 'PreventivoWizardPage usa catalogo PST versionato')
...
assertContains(preventiviPage, 'CodiceOggettoPstSelect', 'PreventiviPage seleziona codice oggetto PST governato')
