...
| --- | --- | --- |
| 00-ci-contracts | Contratti CI, packaging, sicurezza minima e guardrail tecnici rapidi. | 19 |
| 01-flask-core | Bootstrap Flask, autenticazione, sicurezza web, osservabilita' e superfici operative. | 17 |
| 02-react-ui | Contratti React, regia, topbar, layout mobile e coerenza design system. | 22 |
...
| 05-documents | Documenti, template atti, editor, firma visibile e intelligenza documentale. | 35 |
| 06-telematico | PCT, PEC, portali telematici, SIGP, buste, Local Signer e deposito. | 26 |
| 07-lex-ai | Lex, assistenti, fonti ufficiali, legal intelligence, coverage AI e ricerca. | 91 |
| 08-e2e | Flussi end-to-end e golden path ufficiali. | 6 |
| 09-misc | Test non classificati dalle fasi principali | 44 |
...
| Backend domain | API contract | tests/test_legal_skills_engine.py | 401 anonimo, tenant, feature flag | provider verification copre campione; estendere schema response P0/P1 puntuali | censito |
| Backend domain | API contract | tests/test_legal_updates_pipeline.py | tenant, file, audit | provider verification copre campione; estendere schema response P0/P1 puntuali | censito |
...
| Backend domain | Backend | tests/test_normattiva_importer.py | happy/edge path dominio | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Backend domain | Frontend/UI | tests/test_packaging_consistency.py | tenant | nessun runner component/VRT dedicato; copertura via gate statici e browser smoke | censito |
| Backend domain | Frontend/UI | tests/test_practice_engine_profiles.py | happy/edge path dominio | nessun runner component/VRT dedicato; copertura via gate statici e browser smoke | censito |
...
| Backend domain | Frontend/UI | tests/test_regia_api_payloads.py | happy/edge path dominio | nessun runner component/VRT dedicato; copertura via gate statici e browser smoke | censito |
...
| Backend domain | RBAC | tests/test_portali_telematici_matrix.py | 401 anonimo | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Backend domain | RBAC | tests/test_topbar_operational_api.py | 401 anonimo, 403/RBAC, file, audit | estendere solo se emerge una route/area non coperta dalla matrice | censito |
| Backend domain | Security | tests/test_assistente_followup.py | file, audit | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Backend domain | Security | tests/test_local_signer.py | 401 anonimo, 403/RBAC, tenant, contratto, file, audit | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Backend domain | Tenant isolation | tests/test_fascicolo_detail_ux.py | tenant, audit | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Backend domain | Tenant isolation | tests/test_local_ai.py | tenant, contratto, file, audit | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Backend domain | Tenant isolation | tests/test_server_maintenance_surface.py | tenant | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Backend domain | Tenant isolation | tests/test_support_remote.py | tenant, audit | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Comunicazioni | RBAC | tests/test_notifiche_legali.py | 403/RBAC | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Documenti | RBAC | tests/test_template_atti_api_strict.py | audit | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Documenti | Tenant isolation | tests/test_template_atti_editor.py | tenant, audit | estendere solo se emerge una route/area non coperta dalla matrice | censito |
| Fascicoli | API contract | tests/test_fascicoli_pagination.py | happy/edge path dominio | provider verification copre campione; estendere schema response P0/P1 puntuali | censito |
...
| File/document security | Security | tests/test_document_intelligence_api.py | 403/RBAC, file | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Frontend React | API contract | tests/test_react_document_editor.py | happy/edge path dominio | provider verification copre campione; estendere schema response P0/P1 puntuali | censito |
...
| Frontend React | API contract | tests/test_react_scadenziario_additions.py | audit | provider verification copre campione; estendere schema response P0/P1 puntuali | censito |
...
| Frontend React | Frontend/UI | tests/test_regia_ui_react.py | happy/edge path dominio | nessun runner component/VRT dedicato; copertura via gate statici e browser smoke | censito |
...
| Frontend React | Security | tests/test_impostazioni_ai_locale_react.py | feature flag, file | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Lex/Ricerca | API contract | tests/test_lex_professional_upgrade.py | tenant | provider verification copre campione; estendere schema response P0/P1 puntuali | censito |
...
| Lex/Ricerca | Frontend/UI | tests/test_lex_sources_and_studio_data.py | happy/edge path dominio | nessun runner component/VRT dedicato; copertura via gate statici e browser smoke | censito |
...
| Lex/Ricerca | RBAC | tests/test_giurisprudenza.py | file, audit | estendere solo se emerge una route/area non coperta dalla matrice | censito |
