...
- Route nel manifest: 105.
- Priorita route: P0=35; P1=33; P2=37.
...
- Route censite: 14; priorita: P0; P1; P2; migrazione: legacy_operational=3; react_operational_full=11.
- URL legacy principali: /admin/osservabilita; /database; /applicazioni; /privacy/registro/nuovo; /admin/database; /amministrazione; /audit; /privacy/registro; /profili; /profilo; /registro-attivita; /registro-gdpr; +2 altre.
- URL App V2: /app/amministrazione; /app/amministrazione; /app/amministrazione; /app/privacy/registro/nuovo; /app/admin/database; /app/amministrazione; /app/amministrazione?tab=audit; /app/privacy/registro; /app/amministrazione?tab=profili; /app/profilo; /app/amministrazione?tab=audit; /app/registro-gdpr; +2 altre.
