...
- Nel preventivo guidato le fasi tabellari restano visibili anche quando la regola usa `Compenso unico`: il flag unico valorizza la voce unica, resta obbligatorio nei profili che non hanno fasi alternative e impedisce bozze a zero; la complessita stimata bassa/media/alta usa la stessa colonna minimo/base/massimo del tariffario reale della pratica, con bonus telematico allineato e spese generali esposte come voce separata `Spese forfettarie` con percentuale applicata; la clausola controversie resta una sola sezione modificabile e trasferibile al conferimento.
