...
export default function App() {
  ...
  const isLegalSkillsPage = isLegalSkillsCatalogPage || isLegalSkillsProfilePage || isColdStartInterviewPage || isLegalSkillsRunPage || isLegalSkillsReviewPage || isPromptLibraryPage
