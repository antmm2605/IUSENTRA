...
| `python -m pytest tests\test_installation_packs.py -q --tb=short` | OK | 6/6: i manifest Product Pack, Studio Local Pack e Update Pack usano `manifest_hash_sha256` pubblico, non serializzano piu' firme HMAC derivate da segreti e separano il bootstrap della chiave locale dal JSON pubblico. |
