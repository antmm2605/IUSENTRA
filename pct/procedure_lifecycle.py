...
WORKFLOW_STATES: tuple[str, ...] = (
    ...
    "DEPOSITO_ACCETTATO",
    "DEPOSITO_RIFIUTATO",
    "PROVVEDIMENTO_ATTESO",
    "ADEMPIMENTO_SUCCESSIVO_DA_VALUTARE",
    "NOTIFICA_DA_EFFETTUARE",
    "RELATA_DA_GENERARE",
    "NOTIFICA_EFFETTUATA",
    "PROVA_NOTIFICA_ACQUISITA",
    "PROVA_NOTIFICA_DA_DEPOSITARE",
    "PROVA_NOTIFICA_DEPOSITATA",
    "MONITORAGGIO_FASCICOLO",
    "CHIUSA",
)
