...
- Controllare GitHub Actions: `Lint + syntax`, `Pytest core`, `Coverage moduli critici parte */12`, quality gates e CodeQL. Il check aggregatore `Coverage moduli critici` senza `parte` non è un required check.
