...
| `ssh iusentra-hetzner "cd /opt/iusentra/repo && IUSENTRA_SKIP_BACKUP_CRON=1 BRANCH=Codex/legal-electronic-filing-kIxcV bash deploy/hetzner/deploy.sh"` | OK | Deploy Hetzner completato sul commit `d42f31cdf0756561c72253bc8b972bf7924da7cc`; log `Cron backup: non aggiornato`, app/scheduler/OCR/Redis/audit services healthy, runtime container `2.236.7`. |
