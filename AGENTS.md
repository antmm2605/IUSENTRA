...
- **Date e orari visibili sempre italiani e in `Europe/Rome`:** ogni data, orario o timestamp mostrato all'utente in UI, PDF, email, PEC, report, audit, dashboard, preview, pannelli amministrativi e documenti generati deve usare formato italiano e fuso `Europe/Rome`, per esempio `28/06/2026 21:30`. È vietato mostrare all'utente valori raw come `2026-06-28T19:30:19Z`, etichette `Data UTC`, orari UTC o formati internazionali quando non sono tracciati tecnici. La regola vale espressamente anche per data/ora di arrivo PEC, email ordinaria, ricevute, esiti SdI/PCT, notifiche, log operativi e audit visibili. Eccezione: payload tecnici, XML/XSD/EML originali, header email originali, API interne macchina, firme, timestamp RFC 3161 e tracciati ministeriali devono conservare il formato imposto dallo schema, ma la loro rappresentazione visibile deve essere convertita in italiano `Europe/Rome`.
