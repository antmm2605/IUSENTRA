...
| Frontend React | API contract | tests/test_react_legal_intelligence_search.py | happy/edge path dominio | provider verification copre campione; estendere schema response P0/P1 puntuali | censito |
