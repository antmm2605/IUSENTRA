...
TENANT_FILE_SEED_PATHS: tuple[str, ...] = (
    ...
    "agenda/calendar_sync_engine.json",
    "agenda/calendar_conflicts.json",
    "auth/utenti.json",
    "auth/audit.json",
    "backup/config.json",
...
TENANT_DIRECTORY_MERGE_PATHS: tuple[str, ...] = (
    ...
    "fascicoli/archivio",
    "fascicoli/documenti",
    "fascicoli/documenti_ai",
    "fascicoli/importazioni",
...
TENANT_JSON_EMPTY_DEFAULTS: dict[str, Any] = {
    ...
    "agenda/calendar_sync_engine.json": {"accounts": [], "calendars": [], "bindings": [], "jobs": []},
    "agenda/calendar_conflicts.json": {"conflicts": []},
    "auth/utenti.json": {},
    "auth/audit.json": [],
    "backup/config.json": {"max_backup": 1},
    "backup/registro.json": [],
    "clienti/anagrafica.json": {},
    "clienti/condivisioni.json": {"cartelle": {}, "fascicoli": {}, "link": {}},
    "clienti/note_faldone.json": {},
    "config/studio.json": {},
    "email/casella.json": {},
    "email/ordinaria.json": {},
    ...
    "intelligence/motori.json": {},
    "intelligence/tabelle_normative.json": {},
    "intelligence/validation_runs.json": {"runs": []},
    "intelligence/workspace_intelligence.json": {},
    "messaggi/storico.json": {},
    "notifiche/log.json": [],
    "portale/portali.json": {},
...
MODULI_DISPONIBILI: Dict[str, Dict[str, str]] = {
    ...
    "fatturazione":  {"nome": "Parcelle e Fatture", "icona": "bi-receipt-cutoff",   "desc": "Parcelle e fatture professionali"},
    "pagamenti":     {"nome": "Incassi e Pagamenti", "icona": "bi-credit-card-fill", "desc": "Link pagamento e provider digitali"},
    ...
    "template_atti": {"nome": "Redazione Atti",     "icona": "bi-file-earmark-text","desc": "Modelli atti e redazione guidata"},
    ...
    def percorsi_dati(
        ...
        *,
        ...
        return {
            ...
            "CALENDAR_SYNC_ENGINE_DB": f"{base}/agenda/calendar_sync_engine.json",
            "CALENDAR_CONFLICTS_DB": f"{base}/agenda/calendar_conflicts.json",
            "CALENDAR_TOKEN_DB": f"{base}/agenda/cal_token.json",
            ...
            "DOCUMENTI_AI_DIR":   f"{base}/fascicoli/documenti_ai",
            "DOCUMENTI_AI_DB":    f"{base}/fascicoli/documenti_ai/documenti_ai.json",
            "EDITOR_AI_DB":      f"{base}/fascicoli/editor_ai/editor_ai.json",
            "FASCICOLI_IMPORTAZIONI_DIR": f"{base}/fascicoli/importazioni",
            "PEC_CANCELLERIA_STATE_DB": f"{base}/fascicoli/pec_cancelleria_state.json",
            "PRACTICE_ENGINE_DB": f"{base}/fascicoli/practice_engine/practice_engine.json",
            ...
            "STUDIO_TIMBRO_DB": f"{base}/config/studio_timbro.db",
            ...
            "GIURISPRUDENZA_REPOSITORY_DB": f"{base}/intelligence/giurisprudenza_repository.json",
            "GIURISPRUDENZA_SOURCES_REPOSITORY_DB": f"{base}/intelligence/giurisprudenza_sources_repository.json",
            "GIURISPRUDENZA_SYNC_REGISTRY_DB": f"{base}/intelligence/giurisprudenza_sync_registry.json",
            "GIURISPRUDENZA_TAXONOMY_REPOSITORY_DB": f"{base}/intelligence/giurisprudenza_taxonomy_repository.json",
            "GIURISPRUDENZA_USAGE_POLICY_DB": f"{base}/intelligence/giurisprudenza_usage_policy.json",
            "LEGAL_ENGINE_SOURCE_EDGES_DB": f"{base}/intelligence/legal_engine_source_edges.json",
            "LEGAL_ENGINES_REPOSITORY_DB": f"{base}/intelligence/legal_engines_repository.json",
            "LEGAL_INTELLIGENCE_REPOSITORY_DB": f"{base}/intelligence/legal_intelligence_repository.json",
            "LEGAL_KEYWORD_TO_ENGINE_DB": f"{base}/intelligence/legal_keyword_to_engine.json",
            "LEGAL_KEYWORD_TO_SOURCE_DB": f"{base}/intelligence/legal_keyword_to_source.json",
            "LEGAL_OPERATIONAL_REPOSITORY_DB": f"{base}/intelligence/legal_operational_repository.json",
            "LEGAL_SOURCES_REPOSITORY_DB": f"{base}/intelligence/legal_sources_repository.json",
            "LEX_DATASET_DIR": f"{base}/intelligence/lex_dataset",
            "TELEMATICO_ACTIONS_REPOSITORY_DB": f"{base}/intelligence/telematico_actions_repository.json",
            "TELEMATICO_CAPABILITIES_REPOSITORY_DB": f"{base}/intelligence/telematico_capabilities_repository.json",
            "TELEMATICO_CATALOG_SNAPSHOT_DB": f"{base}/intelligence/telematico_catalog_snapshot.json",
            "TELEMATICO_CATALOG_SOURCES_REPOSITORY_DB": f"{base}/intelligence/telematico_catalog_sources_repository.json",
            "TELEMATICO_METHODS_REPOSITORY_DB": f"{base}/intelligence/telematico_methods_repository.json",
            "TELEMATICO_MONITORING_REPOSITORY_DB": f"{base}/intelligence/telematico_monitoring_repository.json",
            "TELEMATICO_REPOSITORY_JSON": f"{base}/intelligence/telematico_repository.json",
            "TELEMATICO_RULES_REPOSITORY_DB": f"{base}/intelligence/telematico_rules_repository.json",
            "TELEMATICO_SOURCES_REPOSITORY_DB": f"{base}/intelligence/telematico_sources_repository.json",
            "TELEMATICO_WIZARD_SECTIONS_REPOSITORY_DB": f"{base}/intelligence/telematico_wizard_sections_repository.json",
            "TELEMATICO_WSDL_MODULES_REPOSITORY_DB": f"{base}/intelligence/telematico_wsdl_modules_repository.json",
            "TELEMATICO_XSD_CHANNELS_REPOSITORY_DB": f"{base}/intelligence/telematico_xsd_channels_repository.json",
            "NORMATIVE_TABLES_DB": f"{base}/intelligence/tabelle_normative.json",
            "GIURISPRUDENZA_DB": f"{base}/intelligence/giurisprudenza.json",
            "LEGAL_SKILLS_DIR": f"{base}/intelligence/legal_skills",
            "LEGAL_SKILLS_PROFILE_DB": f"{base}/intelligence/legal_skills/profile.json",
            "LEGAL_SKILLS_RUNS_DB": f"{base}/intelligence/legal_skills/runs.json",
            "LEGAL_SKILLS_SCHEDULED_DB": f"{base}/intelligence/legal_skills/scheduled.json",
            "WORKFLOW_AGENTS_RUNS_DB": f"{base}/intelligence/workflow_agents/runs.json",
            "WORKFLOW_AGENTS_METRICS_DB": f"{base}/intelligence/workflow_agents/metrics.json",
            "WORKFLOW_AGENTS_ACTIONS_DB": f"{base}/intelligence/workflow_agents/actions.json",
            ...
            "EMAIL_ORDINARIA_DB": f"{base}/email/ordinaria.json",
            "PREVENTIVI_DB":     f"{base}/preventivi/preventivi.json",
            "PREVENTIVI_REPOSITORY_DB": f"{base}/preventivi/preventivi_repository.json",
            "PREVENTIVI_WORKFLOW_STATES_DB": f"{base}/preventivi/preventivi_workflow_states.json",
            "PREVENTIVI_FIELD_MAP_DB": f"{base}/preventivi/preventivi_field_map.json",
            "PREVENTIVI_RULES_DB": f"{base}/preventivi/preventivi_rules.json",
            "TERMINI_PROCESSUALI_DB": f"{base}/scadenziario/termini_processuali.json",
            "SOGGETTI_DB":       f"{base}/soggetti/anagrafica.json",
            "SOGGETTI_PARTI_DB": f"{base}/soggetti/parti.json",
            "TEMPLATE_REPOSITORY_DB": f"{base}/template_atti/template_repository.json",
        }
