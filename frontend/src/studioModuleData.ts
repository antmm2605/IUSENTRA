...
export const studioModules: StudioModuleConfig[] = [
  ...
  },
  {
    ...
    cards: [
      ...
      { title: 'Capitalizzazione di una rendita', body: 'Attualizza il reddito perduto con i coefficienti Milano 2024.', href: '/strumenti-legali/?tool=capitalizzazione_rendita', action: 'Calcola capitale', icon: 'chart', tone: 'primary', meta: 'Risarcimento' },
      { title: 'Danno biologico', body: 'Tabelle vigenti: art. 139 cod. ass., D.P.R. 12/2025 e Milano 2024.', href: '/strumenti-legali/?tool=danno_biologico', action: 'Calcola danno', icon: 'clipboard', tone: 'purple', meta: 'Risarcimento' },
