...
| 07-lex-ai | Lex, assistenti, fonti ufficiali, legal intelligence, coverage AI e ricerca. | 164 |
...
| Audit | Tenant isolation | tests/test_pec_audit_pipeline.py | 401 anonimo, 403/RBAC, tenant, audit | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Backend domain | Frontend/UI | tests/test_busta.py | file, audit | nessun runner component/VRT dedicato; copertura via gate statici e browser smoke | censito |
...
| Backend domain | Frontend/UI | tests/test_packaging_consistency.py | tenant, contratto | nessun runner component/VRT dedicato; copertura via gate statici e browser smoke | censito |
...
| Backend domain | Security | tests/test_local_signer.py | 401 anonimo, 403/RBAC, tenant, feature flag, contratto, file, audit | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Backend domain | Tenant isolation | tests/test_codeql_public_surface_regressions.py | tenant | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Backend domain | Tenant isolation | tests/test_pec_control_tower.py | 403/RBAC, tenant, audit | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| File/document security | RBAC | tests/test_fascicolo_document_catalog.py | tenant, file | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Frontend React | Frontend/UI | tests/test_regia_ui_react.py | 403/RBAC, feature flag, file, audit | nessun runner component/VRT dedicato; copertura via gate statici e browser smoke | censito |
...
| Frontend React | Tenant isolation | tests/test_react_fascicoli_sentenze_economiche.py | tenant, feature flag, audit | estendere solo se emerge una route/area non coperta dalla matrice | censito |
...
| Telematico | Tenant isolation | tests/test_deposito_telematico_catalogo.py | tenant, feature flag, contratto | estendere solo se emerge una route/area non coperta dalla matrice | censito |
