...
- Endpoint P0/P1 con contratto OpenAPI: 310.
...
- Endpoint con provider verification 401 reale o errore pubblico sicuro: 364.
- Endpoint pubblici Portale Cliente verificati senza token valido: 27.
