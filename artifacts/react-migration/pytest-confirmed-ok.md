...
| `python tools\check_local_signer_boundaries.py` | OK | Gate di confine Local Signer verde: documento baseline presente, niente preflight PIN nei wizard, sessione PST preservata e download batch obbligatorio. |
