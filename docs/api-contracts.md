...
- Endpoint React API contrattualizzati: 299.
- Endpoint P0/P1 con contratto OpenAPI: 261.
...
- Endpoint con provider verification 401 reale o errore pubblico sicuro: 299.
