...
- Endpoint React API contrattualizzati: 277.
- Endpoint P0/P1 con contratto OpenAPI: 246.
...
- Endpoint con provider verification 401 reale o errore pubblico sicuro: 277.
