...
- Priorita route: P0=31; P1=38; P2=37.
...
- Stato: `complete_tested` (area senza route pendenti/parziali e con P0/P1 coperti dai gate comuni piu' registro fase 8).
- Route censite: 7; priorita: P1; P2; migrazione: react_operational_full=7.
- URL legacy principali: /sito-studio/builder; /sito-studio/redazione-ai; /strumenti-legali; /sito-studio; /sito-studio/contatti; /statistiche; /strumenti-operativi.
- URL App V2: /app/amministrazione?tab=studio; /app/amministrazione?tab=studio-redazione-ai; /app/studio; /app/amministrazione?tab=studio; /app/amministrazione?tab=studio; /app/regia?tab=statistiche; /app/studio.
