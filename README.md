...
- Nel preventivo guidato le fasi tabellari restano visibili anche quando la regola usa `Compenso unico`: il flag unico e' aggiuntivo, attivo valorizza il compenso tabellare e disattivo non produce importo; la clausola controversie resta una sola sezione modificabile e trasferibile al conferimento.
