...
assertContains(studioModules, "href: '/app-v2/polisweb#acquisizione-portale'", 'acquisizione PST React esplicita')
assertContains(studioModules, "href: '/app-v2/polisweb#checklist-operativa'", 'checklist PST React esplicita')
