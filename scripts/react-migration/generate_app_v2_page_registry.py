...
def _registry_doc(
    ...
    lines = [
        ...
        "## Copertura UI fase 9",
        "",
        "Storybook e' configurato nel workspace pnpm/Turborepo per il frontend e per `packages/ui`. La copertura minima fase 9 usa fixture sicure isolate, `scripts/validate_ui_coverage.py`, `pnpm test`, `pnpm typecheck`, `pnpm build` e `pnpm build:storybook`. VRT resta gap documentato finche' Chromatic non viene attivato con token reale.",
        "",
        _table(
