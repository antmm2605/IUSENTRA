...
export const studioModules: StudioModuleConfig[] = [
  ...
  },
  {
    ...
    subtitle: 'Superficie operativa per acquisire pratiche da PST con Local Connector, file autorizzati e percorso guidato governato.',
  ...
  },
  {
    ...
    subtitle: 'Indice operativo delle impostazioni sensibili: dati studio, comunicazioni, pagamenti, backup, calendari e AI locale.',
    lexContext: 'impostazioni-studio',
    lexLabel: 'Lex legge configurazione e guida ai controlli senza esporre credenziali.',
    kpis: [
      { label: 'Tab', value: '11', note: 'studio, comunicazioni, pagamenti, backup, calendari e AI', tone: 'primary' },
    ...
    cards: [
      ...
      { title: 'AI locale', body: 'Configura assistente sul PC dello studio e reindicizzazione documenti.', href: '/impostazioni?tab=ai', action: 'Apri AI', icon: 'spark', tone: 'purple', meta: 'Lex' },
