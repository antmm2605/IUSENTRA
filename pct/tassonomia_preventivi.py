...
SOURCE_CATALOG: Dict[str, Dict[str, str]] = {
    ...
    "codice_civile": {
        "id": "codice_civile",
        "title": "Codice civile",
        "article": "r.d. 16 marzo 1942, n. 262",
        "authority": "Normattiva",
        "url": "https://www.normattiva.it/uri-res/N2Ls?urn%3Anir%3Astato%3Aregio.decreto%3A1942-03-16%3B262",
        "checked_on": "2026-04-03",
        "scope": "diritto societario e commerciale",
        "note": "Fonte normativa base per societa, contratti, responsabilita e operazioni straordinarie.",
    },
    "tui_immigrazione": {
        "id": "tui_immigrazione",
        "title": "D.Lgs. 25 luglio 1998, n. 286",
        "article": "Testo Unico sull'immigrazione",
        "authority": "Normattiva",
        "url": "https://www.normattiva.it/uri-res/N2Ls?urn%3Anir%3Astato%3Adecreto.legislativo%3A1998-07-25%3B286",
        "checked_on": "2026-04-03",
        "scope": "immigrazione e cittadinanza",
        "note": "Fonte principale per soggiorno, lavoro straniero, espulsione e ricongiungimento familiare.",
    },
    "l91_1992_cittadinanza": {
        "id": "l91_1992_cittadinanza",
        "title": "L. 5 febbraio 1992, n. 91",
        "article": "cittadinanza italiana",
        "authority": "Normattiva",
        "url": "https://www.normattiva.it/uri-res/N2Ls?urn%3Anir%3Astato%3Alegge%3A1992-02-05%3B91",
        "checked_on": "2026-04-03",
        "scope": "acquisto, perdita e riacquisto della cittadinanza",
        "note": "Fonte normativa base per acquisto, perdita e riacquisto della cittadinanza italiana.",
    },
}
...
NODE_CATALOG: Dict[str, Dict[str, Any]] = {
    ...
    # ── FAMIGLIA E PERSONE ───────────────────────────────────────────────────
    "GIU_FAM_SEPARAZIONE_DIVORZIO": {
        "area_code": "GIU",
        "area_label": "Giudiziale",
        "macro_code": "FAM",
        "macro_label": "Diritto di Famiglia",
        "sub_code": "SEPARAZIONE_DIVORZIO",
        "sub_label": "Separazione, divorzio e modifica condizioni",
        "description": "Procedimenti di crisi coniugale in sede giudiziale e consensuale.",
        "source_ids": COMMON_SOURCE_IDS + ("cpc",),
    },
    "GIU_FAM_MINORI_GENITORIALE": {
        "area_code": "GIU",
        "area_label": "Giudiziale",
        "macro_code": "FAM",
        "macro_label": "Diritto di Famiglia",
        "sub_code": "MINORI_GENITORIALE",
        "sub_label": "Minori, responsabilita genitoriale e affidamento",
        "description": "Procedimenti camerali e contenziosi su minori, affidamento e mantenimento.",
        "source_ids": COMMON_SOURCE_IDS + ("cpc",),
    },
    "VOL_FAM_PROTEZIONE_PERSONA": {
        "area_code": "VOL",
        "area_label": "Volontaria Giurisdizione",
        "macro_code": "FAM",
        "macro_label": "Diritto di Famiglia",
        "sub_code": "PROTEZIONE_PERSONA_VG",
        "sub_label": "Amministrazione di sostegno, tutela e curatela",
        "description": "Procedimenti di protezione della persona davanti al giudice tutelare.",
        "source_ids": COMMON_SOURCE_IDS + ("cpc", "ads_ministero"),
    },
    # ── LAVORO E PREVIDENZA ──────────────────────────────────────────────────
    "GIU_LAV_SUBORDINATO": {
        ...
        "macro_code": "LAV",
        "macro_label": "Diritto del Lavoro",
        "sub_code": "LAVORO_SUBORDINATO_IMPUGNAZIONI",
        "sub_label": "Lavoro subordinato, licenziamenti e impugnazioni",
        "description": "Rito lavoro di primo grado e impugnazioni su rapporto di lavoro subordinato.",
        "source_ids": COMMON_SOURCE_IDS + ("cpc",),
    },
    "GIU_PRE_INPS_INAIL": {
        "area_code": "GIU",
        ...
        "macro_code": "PRE",
        "macro_label": "Previdenza e assistenza",
        "sub_code": "INPS_INAIL_ASSISTENZA",
        "sub_label": "INPS, INAIL, assistenza e ricorsi amministrativi",
        "description": "Contenzioso previdenziale e assistenziale e fasi amministrative collegate.",
        "source_ids": COMMON_SOURCE_IDS + ("cpc",),
    },
    # ── ESECUZIONI CIVILI ────────────────────────────────────────────────────
    "ESE_CIV_PIGNORAMENTI": {
        "area_code": "ESE",
        "area_label": "Esecuzione Forzata",
        "macro_code": "ESE_CIV",
        "macro_label": "Esecuzioni Civili",
        "sub_code": "PIGNORAMENTI_OPPOSIZIONI",
        "sub_label": "Precetti, pignoramenti, esecuzioni e opposizioni",
        "description": "Esecuzione forzata mobiliare, immobiliare e presso terzi con relativi rimedi.",
        "source_ids": COMMON_SOURCE_IDS + ("cpc",),
    },
    # ── AMMINISTRATIVO (espansione) ──────────────────────────────────────────
    "GIU_AMM_ACCESSO_SILENZIO": {
        "area_code": "GIU",
        "area_label": "Giudiziale",
        "macro_code": "AMM",
        "macro_label": "Giustizia Amministrativa",
        "sub_code": "ACCESSO_SILENZIO_PA",
        "sub_label": "Accesso agli atti, silenzio-inadempimento e sanzioni AMM",
        "description": "Ricorsi per accesso documentale / FOIA, silenzio della PA e opposizione a sanzioni amministrative.",
        "source_ids": COMMON_SOURCE_IDS + ("cpa",),
    },
    "GIU_AMM_APPALTI_ESPROPRIO": {
        "area_code": "GIU",
        "area_label": "Giudiziale",
        "macro_code": "AMM",
        "macro_label": "Giustizia Amministrativa",
        "sub_code": "APPALTI_ESPROPRIAZIONE",
        "sub_label": "Appalti, contratti pubblici ed espropriazione per pubblica utilita",
        "description": "Contenzioso su procedure di gara, aggiudicazione e procedimenti espropriativi.",
        "source_ids": COMMON_SOURCE_IDS + ("cpa", "ga_funzioni"),
    },
    # ── TRIBUTARIO (espansione) ──────────────────────────────────────────────
    "STR_TRB_CONSULENZA_DEFLATTIVA": {
        "area_code": "STR",
        "area_label": "Stragiudiziale",
        "macro_code": "TRB",
        "macro_label": "Giustizia Tributaria",
        "sub_code": "CONSULENZA_DEFLATTIVA",
        "sub_label": "Consulenza fiscale, procedure deflattive e concordato biennale",
        "description": "Assistenza stragiudiziale tributaria: pareri, mediazione fiscale, definizioni agevolate e CPB.",
        "source_ids": COMMON_SOURCE_IDS + ("tributario_546",),
    },
    "GIU_TRB_DOGANALE": {
        "area_code": "GIU",
        "area_label": "Giudiziale",
        "macro_code": "TRB",
        "macro_label": "Giustizia Tributaria",
        "sub_code": "DOGANALE_ACCISE",
        "sub_label": "Contenzioso doganale e accise",
        "description": "Ricorsi tributari in materia doganale, accise e tributi indiretti speciali.",
        "source_ids": COMMON_SOURCE_IDS + ("tributario_546",),
    },
    # ── PENALE DIFENSIVO ─────────────────────────────────────────────────────
    "GIU_PENDEF_ORDINARIO": {
        "area_code": "GIU",
        "area_label": "Giudiziale",
        "macro_code": "PENDEF",
        "macro_label": "Diritto Penale difensivo",
        "sub_code": "DIFESA_ORDINARIA",
        "sub_label": "Difesa ordinaria: indagini, GUP, dibattimento e impugnazioni",
        "description": "Difesa dell'imputato nelle fasi ordinarie del procedimento penale.",
        "source_ids": COMMON_SOURCE_IDS + ("cpp",),
    },
    "GIU_PENDEF_SPECIALI": {
        "area_code": "GIU",
        ...
        "macro_code": "PENDEF",
        "macro_label": "Diritto Penale difensivo",
        "sub_code": "DIFESA_SPECIALE",
        "sub_label": "Riti speciali, cautelari, sorveglianza e vittime",
        "description": "Riti alternativi, misure cautelari, sorveglianza penale e assistenza alla vittima.",
        "source_ids": COMMON_SOURCE_IDS + ("cpp",),
    },
    # ── SOCIETARIO ───────────────────────────────────────────────────────────
    "STR_SOC_CONSULENZA": {
        ...
        "area_label": "Stragiudiziale",
        "macro_code": "SOC",
        "macro_label": "Diritto Societario e Commerciale",
        "sub_code": "SOC_STRAGIUDIZIALE",
        "sub_label": "Consulenza, contratti e operazioni societarie stragiudiziali",
        "description": "Assistenza stragiudiziale in materia di societa, contratti commerciali e operazioni straordinarie.",
        "source_ids": COMMON_SOURCE_IDS + ("codice_civile",),
    },
    "GIU_SOC_CONTENZIOSO": {
        "area_code": "GIU",
        "area_label": "Giudiziale",
        "macro_code": "SOC",
        "macro_label": "Diritto Societario e Commerciale",
        "sub_code": "SOC_CONTENZIOSO",
        "sub_label": "Contenzioso societario giudiziale",
        "description": "Contenzioso civile in materia societaria e responsabilita degli organi sociali.",
        "source_ids": COMMON_SOURCE_IDS + ("cpc", "codice_civile"),
    },
    # ── IMMIGRAZIONE ─────────────────────────────────────────────────────────
    "STR_MIG_CONSULENZA": {
        "area_code": "STR",
        "area_label": "Stragiudiziale",
        "macro_code": "MIG",
        "macro_label": "Immigrazione e Cittadinanza",
        "sub_code": "MIG_AMMINISTRATIVO",
        "sub_label": "Permessi, ricongiungimento, cittadinanza e visti",
        "description": "Pratiche amministrative in materia di soggiorno, cittadinanza e ingressi.",
        "source_ids": COMMON_SOURCE_IDS + ("tui_immigrazione", "l91_1992_cittadinanza"),
    },
    "GIU_MIG_CONTENZIOSO": {
        "area_code": "GIU",
        "area_label": "Giudiziale",
        "macro_code": "MIG",
        "macro_label": "Immigrazione e Cittadinanza",
        "sub_code": "MIG_CONTENZIOSO",
        "sub_label": "Protezione internazionale, espulsione e ricorsi giudiziali",
        "description": "Ricorsi giudiziali per protezione internazionale, espulsione e riconoscimento status.",
        "source_ids": COMMON_SOURCE_IDS + ("tui_immigrazione",),
    },
}
...
PRACTICE_NODE_MAP: Dict[str, str] = {
    ...
    "precetto": "ESE_CIV_PIGNORAMENTI",
    "pignoramento": "ESE_CIV_PIGNORAMENTI",
    "esecuzione_mobiliare": "ESE_CIV_PIGNORAMENTI",
    "esecuzione_immobiliare": "ESE_CIV_PIGNORAMENTI",
    "esecuzione_terzi": "ESE_CIV_PIGNORAMENTI",
    "opposizione_esecutiva": "ESE_CIV_PIGNORAMENTI",
    "opposizione_atti_esecutivi": "ESE_CIV_PIGNORAMENTI",
    "separazione_consensuale": "GIU_FAM_SEPARAZIONE_DIVORZIO",
    "separazione_giudiziale": "GIU_FAM_SEPARAZIONE_DIVORZIO",
    "divorzio_congiunto": "GIU_FAM_SEPARAZIONE_DIVORZIO",
    "divorzio_giudiziale": "GIU_FAM_SEPARAZIONE_DIVORZIO",
    "procedimenti_famiglia": "GIU_FAM_MINORI_GENITORIALE",
    "procedimenti_minori": "GIU_FAM_MINORI_GENITORIALE",
    "modifica_condizioni_famiglia": "GIU_FAM_SEPARAZIONE_DIVORZIO",
    "responsabilita_genitoriale": "GIU_FAM_MINORI_GENITORIALE",
    "reclamo_famiglia_minori": "GIU_FAM_MINORI_GENITORIALE",
    "appello_famiglia_minori": "GIU_FAM_SEPARAZIONE_DIVORZIO",
    "amministrazione_sostegno": "VOL_FAM_PROTEZIONE_PERSONA",
    "nomina_amministratore_sostegno": "VOL_FAM_PROTEZIONE_PERSONA",
    "modifica_revoca_ads": "VOL_FAM_PROTEZIONE_PERSONA",
    "tutela_curatela": "VOL_FAM_PROTEZIONE_PERSONA",
    "reclamo_giudice_tutelare": "VOL_FAM_PROTEZIONE_PERSONA",
    "sfratto_morosita": "GIU_CIV_LOCAZIONI",
    "risarcimento_danni": "GIU_CIV_RESPONSABILITA",
    "controversia_lavoro": "GIU_LAV_SUBORDINATO",
    "licenziamento": "GIU_LAV_SUBORDINATO",
    "differenze_retributive": "GIU_LAV_SUBORDINATO",
    "appello_lavoro": "GIU_LAV_SUBORDINATO",
    "cassazione_lavoro": "GIU_LAV_SUBORDINATO",
    "previdenza": "GIU_PRE_INPS_INAIL",
    "appello_previdenza": "GIU_PRE_INPS_INAIL",
    "cassazione_previdenza": "GIU_PRE_INPS_INAIL",
    "assistenza_previdenziale": "GIU_PRE_INPS_INAIL",
    ...
    # ── AMMINISTRATIVO (espansione) ──
    "accesso_atti": "GIU_AMM_ACCESSO_SILENZIO",
    "silenzio_inadempimento": "GIU_AMM_ACCESSO_SILENZIO",
    "sanzioni_amministrative": "GIU_AMM_ACCESSO_SILENZIO",
    "appalti_contratti_pubblici": "GIU_AMM_APPALTI_ESPROPRIO",
    "espropriazione_pu": "GIU_AMM_APPALTI_ESPROPRIO",
    # ── TRIBUTARIO (espansione) ──
    "consulenza_tributaria": "STR_TRB_CONSULENZA_DEFLATTIVA",
    "procedure_deflattive": "STR_TRB_CONSULENZA_DEFLATTIVA",
    "concordato_biennale": "STR_TRB_CONSULENZA_DEFLATTIVA",
    "contenzioso_doganale": "GIU_TRB_DOGANALE",
    # ── PENALE DIFENSIVO ──
    "consulenza_difensiva": "GIU_PENDEF_ORDINARIO",
    "difesa_indagini": "GIU_PENDEF_ORDINARIO",
    "difesa_gup": "GIU_PENDEF_ORDINARIO",
    "difesa_monocratico": "GIU_PENDEF_ORDINARIO",
    "difesa_collegiale": "GIU_PENDEF_ORDINARIO",
    "difesa_assise": "GIU_PENDEF_ORDINARIO",
    "riti_alternativi": "GIU_PENDEF_SPECIALI",
    "difesa_appello_penale": "GIU_PENDEF_ORDINARIO",
    "difesa_cassazione_penale": "GIU_PENDEF_ORDINARIO",
    "difesa_cautelari": "GIU_PENDEF_SPECIALI",
    "difesa_sorveglianza": "GIU_PENDEF_SPECIALI",
    "assistenza_vittima_reato": "GIU_PENDEF_SPECIALI",
    # ── SOCIETARIO ──
    "consulenza_societaria": "STR_SOC_CONSULENZA",
    "costituzione_modifica_societa": "STR_SOC_CONSULENZA",
    "governance_societaria": "STR_SOC_CONSULENZA",
    "contratti_commerciali": "STR_SOC_CONSULENZA",
    "contenzioso_societario": "GIU_SOC_CONTENZIOSO",
    "responsabilita_organi_sociali": "GIU_SOC_CONTENZIOSO",
    "operazioni_straordinarie": "STR_SOC_CONSULENZA",
    # ── IMMIGRAZIONE ──
    "consulenza_immigrazione": "STR_MIG_CONSULENZA",
    "permesso_soggiorno": "STR_MIG_CONSULENZA",
    "protezione_internazionale": "GIU_MIG_CONTENZIOSO",
    "difesa_espulsione_rimpatrio": "GIU_MIG_CONTENZIOSO",
    "ricongiungimento_familiare": "STR_MIG_CONSULENZA",
    "cittadinanza_italiana": "STR_MIG_CONSULENZA",
    "visto_lavoro_ingresso": "STR_MIG_CONSULENZA",
}
