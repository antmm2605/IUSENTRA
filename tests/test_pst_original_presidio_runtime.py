...
def test_presidio_riconosce_provvedimento_pst_gia_presente_nel_fascicolo(monkeypatch, tmp_path: Path) -> None:
    ...
    fascicolo = SimpleNamespace(
        documenti=[
            ...
            SimpleNamespace(
                id="QO-SENTENZA-1",
                nome="Sentenza Cassazione.PDF",
                nome_originale="20260513115717415.PDF",
                tipo="SENTENZA",
                tipo_atto_portale="Sentenza",
                id_documento_portale="quickorganizer:testi:8831",
                note="Documento storico importato da QuickOrganizer.",
                tags=["Documenti fascicolo", "Sentenza"],
            ),
            SimpleNamespace(
                id="QO-SENTENZA-2",
                nome="Tribunale-di-Cosenza-Sentenza-n.-394-2023-del-08.03.23",
                nome_originale="20260513115717606.PDF",
                tipo="SENTENZA",
                tipo_atto_portale="Sentenza",
                id_documento_portale="quickorganizer:testi:8832",
                note="Documento storico importato da QuickOrganizer.",
                tags=["Documenti fascicolo", "Sentenza"],
            ),
            SimpleNamespace(
