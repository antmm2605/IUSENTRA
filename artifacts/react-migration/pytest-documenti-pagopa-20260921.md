...
Riallineate otto sorgenti/test già presenti sul server relativi al catalogo e alle letture pianificate, preservando la baseline operativa: otto test mirati passati. Il deploy ora si ferma in presenza di modifiche non consolidate, invece di usare checkout forzato/reset hard/clean. Scheduler locale tornato healthy dopo la ripresa delle esecuzioni. Backup SQL preventivo di produzione creato separatamente: 337 righe fascicoli, senza sovrascrivere il database attivo.
