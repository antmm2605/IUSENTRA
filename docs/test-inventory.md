...
| 02-react-ui | Contratti React, regia, topbar, layout mobile e coerenza design system. | 35 |
...
| 09-misc | Test non classificati dalle fasi principali | 197 |
...
| Backend domain | Backend | tests/test_pec_change_receipt.py | audit | estendere solo se emerge una route/area non coperta dalla matrice | censito |
