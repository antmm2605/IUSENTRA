...
- Endpoint React API contrattualizzati: 256.
- Endpoint P0/P1 con contratto OpenAPI: 225.
...
- Endpoint con provider verification 401 reale o errore pubblico sicuro: 256.
- Endpoint pubblici Portale Cliente verificati senza token valido: 14.
