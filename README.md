...
- Nel preventivo guidato le fasi tabellari restano visibili anche quando la regola usa `Compenso unico`: il flag unico e' aggiuntivo, attivo valorizza la voce unica e disattivo calcola le fasi selezionate; la clausola controversie resta una sola sezione modificabile e trasferibile al conferimento.
