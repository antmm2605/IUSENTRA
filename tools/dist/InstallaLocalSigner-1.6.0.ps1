...
# Pacchetto generato il 2026-04-14 00:03:50
...
Write-Step "Installo dipendenze base (asn1crypto, cryptography, zeep, pdfplumber, mammoth)..."
& $pythonExe -m pip install --quiet --no-warn-script-location "asn1crypto>=1.5.0" "cryptography>=41.0.0" "zeep>=4.2.1" "pdfplumber>=0.10.0" "mammoth>=1.6.0"
