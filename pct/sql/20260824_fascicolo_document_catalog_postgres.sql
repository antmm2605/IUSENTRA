-- Catalogazione documentale del fascicolo - schema PostgreSQL.
-- Contratto intenzionalmente equivalente alla migrazione SQLite 20260824.
...
CREATE TABLE IF NOT EXISTS document_catalog_source_snapshots (
    id TEXT PRIMARY KEY,
    tenant_id TEXT NOT NULL,
    rule_set_id TEXT NOT NULL REFERENCES document_catalog_rule_sets(id) ON DELETE CASCADE,
...
-- Compatibilità con la prima build del catalogo, che impediva erroneamente
