...
_INTENT_CATALOG: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "patterns": (
            ...
            r"\b(?:quale|quali|che)\s+pec\b.*\b(?:deposit|controll|verific|presidi|audit|mime|firma|firme)\w*\b",
            r"\bpec\b.*\b(?:deposit|controll|verific|presidi|audit|mime|firma|firme|cancelleria|giudice\s+di\s+pace|d\.l\.\s*179)\w*\b",
            r"\b(?:deposit|controll|verific|presidi|audit|mime|notific)\w*\b.*\bpec\b",
            ...
            r"\bquale\s+atto\b.*\b(?:notificat|depositat|comunicat)\w*\b.*\ballegat\w*\b",
            r"\b(?:notificat|depositat|comunicat)\w*\b.*\ballegat\w*\b",
            r"\b(?:atto|atti)\b.*\ballegat\w*\b.*\b(?:pec|email|mail|messagg|comunicazion|notificat|depositat|comunicat)\w*\b",
    ...
    },
    {
        ...
        "patterns": (
            r"\bdiffida\b",
            r"\b(?:scrivi|redigi|prepara)(?:mi)?\b.*\bpec\b",
            r"\bbozza\b.*\bpec\b",
            r"\bpec\b.*\b(?:formale|legale|da inviare)\b",
            r"\blettera\b",
            r"\bsollecito\b",
            r"\bmessa in mora\b",
