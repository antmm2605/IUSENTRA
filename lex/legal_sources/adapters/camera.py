...
class CameraAdapter(BaseLegalSourceAdapter):
    def __init__(self) -> None:
        metadata = source_metadata(
            source_id="camera",
            display_name="Camera dei Deputati",
        ...
        super().__init__(
            ...
            manuscript=source_manuscript(
                metadata=metadata,
                access_modes=["open data ufficiale", "atti parlamentari", "SPARQL/RDF ove documentato"],
                identifiers_supported=["atto parlamentare", "numero ddl", "legislatura", "seduta"],
