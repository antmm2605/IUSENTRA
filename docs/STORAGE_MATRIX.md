...
| Operativita' fascicolo | Documenti AI Fascicolo | R/W | R/W | R/W | schema governato | Wave 3 - workspace professionali | JSON tenant-aware in `fascicoli/documenti_ai/documenti_ai.json`; SQLite/PostgreSQL predisposti in `pct/sql/20260505_documenti_ai*.sql`; file originali e testi estratti su filesystem tenant |
