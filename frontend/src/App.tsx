...
export default function App() {
  ...
  const isStudioModulePage = !isAdminDatabasePage && !isStatistichePage && !isAuditPage && !isRegistroAttivitaPage && !isTimesheetPage && !isCartelleCondivisePage && !isWizardProPage && isStudioModuleRoute(routeKey)
