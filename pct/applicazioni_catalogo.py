...
ITEM_OVERRIDES: Dict[str, Dict[str, Any]] = {
    ...
    "ricerca_applicazioni": {
        "summary": "Ricerca centralizzata nel catalogo applicazioni con filtri per area, stato e utilizzo operativo.",
        "status": "operativa",
        "endpoint": "applicazioni.index",
        "cta_label": "Apri ricerca applicazioni",
    },
    ...
    "procura_alle_liti": {"status": "guidata", "endpoint": "template_atti.catalogo", "cta_label": "Apri template atti"},
    "attestazione_conformita": {"status": "guidata", "endpoint": "template_atti.catalogo", "cta_label": "Apri template atti"},
    "relata_notifica_pec": {"status": "guidata", "endpoint": "template_atti.catalogo", "cta_label": "Apri template atti"},
    "deposito_telematico_documenti": {"status": "guidata", "endpoint": "telematico_dashboard", "cta_label": "Apri cabina telematica"},
    "visibilita_fascicolo_telematico": {"status": "guidata", "endpoint": "telematico_dashboard", "cta_label": "Apri cabina telematica"},
    "note_di_trattazione_scritta": {"status": "guidata", "endpoint": "template_atti.catalogo", "cta_label": "Apri template atti"},
    ...
    "fatturazione_avvocati": {"status": "operativa", "endpoint": "fatturazione.lista", "cta_label": "Apri fatturazione"},
    "preventivo_cause_civili": {"status": "operativa", "endpoint": "preventivi.wizard", "cta_label": "Apri wizard preventivo"},
    "preventivo_attivita_stragiudiziali": {"status": "operativa", "endpoint": "preventivi.wizard", "cta_label": "Apri wizard preventivo"},
    "fattura_avvocati": {"status": "operativa", "endpoint": "fatturazione.nuova", "cta_label": "Crea fattura"},
    "parametri_2014_civile": {"status": "guidata", "endpoint": "tariffario", "cta_label": "Apri tariffario"},
    "parametri_2014_penale": {"status": "guidata", "endpoint": "tariffario", "cta_label": "Apri tariffario"},
    "parametri_stragiudiziali": {"status": "guidata", "endpoint": "tariffario", "cta_label": "Apri tariffario"},
    "tabelle_parametri": {"status": "guidata", "endpoint": "tariffario", "cta_label": "Apri tariffario"},
    ...
    "calcolo_preventivo": {"status": "operativa", "endpoint": "preventivi.wizard", "cta_label": "Apri wizard preventivo"},
