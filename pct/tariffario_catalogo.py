...
TABELLE_SNAPSHOT_META.update(
    {
        ...
        "A14": {"table_label": "Tabella 14 - Giudizi innanzi alla Corte costituzionale, alla Corte europea, alla Corte di giustizia UE", "area_scope": "Giurisdizioni superiori", "grade_scope": "Corte cost. / Corte europea / CGUE"},
...
_upsert_rows(
    ...
    [
        ...
        {
            "profile_code": "giurisdizioni_superiori",
            "materia_key": "GIURISDIZIONI_SUPERIORI",
            "materia_label": "Giurisdizioni superiori / europee",
            "grado_key": "CORTE_SUPERIORE_UE",
            "grado_label": "Corte cost. / Corte europea / CGUE",
            "table_code": "A14",
            ...
            "summary": "Giudizi davanti alle giurisdizioni superiori costituzionali o sovranazionali.",
            "base_note": "Calcolo diretto sulla tabella 14 del D.M. 147/2022.",
        },
        {
...
_upsert_rows(
    ...
    [
        ...
        {
            "rule_code": "giurisdizioni_superiori",
            "materia_label": "Giurisdizioni superiori / europee",
            "label": "Corte costituzionale / Corte europea / CGUE",
            "summary": "Giudizi davanti alle giurisdizioni costituzionali e sovranazionali con tabella dedicata.",
            "profile_code": "giurisdizioni_superiori",
            "suggested_practice_id": "giurisdizioni_superiori",
            "grado_input_value": "Corte cost. / Corte europea / CGUE",
            "allowed_grade_input_values": ["Corte cost. / Corte europea / CGUE"],
        },
        {
...
def default_rule_for_practice(practice_id: str) -> Optional[Dict[str, Any]]:
    ...
    practice_map = {
        ...
        "giurisdizioni_superiori": "Corte cost. / Corte europea / CGUE",
