# HACS Local Signer Setup v1.5.35
# Pacchetto generato il 2026-04-11 23:43:53
...
Write-Step "Installo dipendenze base (asn1crypto, cryptography, zeep)..."
& $pythonExe -m pip install --quiet --no-warn-script-location "asn1crypto>=1.5.0" "cryptography>=41.0.0" "zeep>=4.2.1"
