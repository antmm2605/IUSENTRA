...
| Browser Playwright desktop/tablet/mobile su fascicolo con codice `010001` | OK | Guida visibile, badge `Codice PST verificato`, badge `Guida curata`, nessun overflow orizzontale, nessun errore console e nessun testo tecnico vietato. Report: `artifacts\guida-pratica\browser-guida-pratica-report.json`. |
