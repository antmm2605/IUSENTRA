...
- **Orari visibili sempre in ora italiana:** ogni timestamp salvato o ricevuto in UTC deve essere convertito e mostrato in `Europe/Rome` su UI, report, pannelli amministrativi, audit e verifiche browser. Non dichiarare corretto un flusso se un orario visibile resta in UTC o non coincide con l'ora italiana attesa.
