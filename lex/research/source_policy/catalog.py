...
AREA_KEYWORDS: dict[str, list[str]] = {
    ...
    "tributario": ["fisco", "tasse", "imposta", "iva", "irpef", "ires", "agenzia entrate", "accertamento", "ravvedimento", "compensazione", "ruolo"],
    ...
    "amministrativo": ["tar", "consiglio di stato", "provvedimento", "accesso atti", "silenzio assenso", "procedimento amministrativo", "autotutela", "interesse legittimo"],
    "appalti": ["appalto", "gara", "codice appalti", "anac", "aggiudicazione", "contratto pubblico", "cig", "consip", "dgue"],
    "penale": ["reato", "penale", "imputato", "processo penale", "misure cautelari", "codice penale", "procura", "patteggiamento"],
    "civile": ["responsabilita civile", "risarcimento", "contratto", "obbligazioni", "proprieta", "codice civile", "usucapione", "successione"],
    "famiglia": ["divorzio", "separazione", "affido", "mantenimento", "diritto di famiglia", "matrimonio", "minori", "adozione"],
