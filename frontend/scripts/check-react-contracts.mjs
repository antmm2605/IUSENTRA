...
assertContains(reactEntry, "await import('./app/App')", 'reactEntry carica l’app operativa dopo il bootstrap minimo')
assertContains(reactEntry, "await import('./components/SupportOperatorRoom')", 'reactEntry carica supporto remoto dopo il bootstrap minimo')
