...
DEFAULT_TEMPLATES: tuple[DeadlineTemplate, ...] = (
    ...
    DeadlineTemplate(
        code="CIV_DI_NOTIFICA_644",
        name="Decreto ingiuntivo - notifica entro 60 giorni",
        base_value=60,
        reference_law="Art. 644 c.p.c.",
        metadata={"source_event": "pronuncia_decreto"},
    ),
    DeadlineTemplate(
        code="CIV_RECLAMO_CAUTELARE_669_TERDECIES",
        name="Reclamo cautelare",
        base_value=15,
        reference_law="Art. 669-terdecies c.p.c.",
        metadata={"source_event": "pronuncia_udienza"},
    ),
    DeadlineTemplate(
        code="CIV_CASSAZIONE_380_BIS",
        name="Cassazione - richiesta decisione dopo proposta 380-bis",
        base_value=40,
        reference_law="Art. 380-bis c.p.c.",
        metadata={"source_event": "comunicazione"},
    ),
    DeadlineTemplate(
        code="CIV_OPPOSIZIONE_127_TER",
        name="Opposizione alla trattazione scritta",
        base_value=5,
        reference_law="Art. 127-ter c.p.c.",
        metadata={"source_event": "comunicazione"},
    ),
    DeadlineTemplate(
