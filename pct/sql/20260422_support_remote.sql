CREATE TABLE IF NOT EXISTS support_session (
    ...
    consent_screen INTEGER NOT NULL DEFAULT 0,
    consent_audio INTEGER NOT NULL DEFAULT 0,
    consent_chat INTEGER NOT NULL DEFAULT 1,
    consent_advanced_control INTEGER NOT NULL DEFAULT 0,
    advanced_control_requested INTEGER NOT NULL DEFAULT 0,
    advanced_control_approved INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS support_event (
    ...
    created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (session_id) REFERENCES support_session(id) ON DELETE CASCADE
);
