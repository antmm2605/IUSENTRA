...
assertContains(uiRegressionDoc, 'Storybook: introdotto', 'docs/ui-regression-and-storybook.md Storybook')
assertContains(uiRegressionDoc, 'VRT: predisposto tramite Chromatic', 'docs/ui-regression-and-storybook.md VRT')
