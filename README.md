...
- Lex include il `Legal Skills Engine`: pack read-only per contratti, privacy, contenzioso e regolatorio, con profilo studio obbligatorio, fonti governate, note di revisione, approvazione e UI React dedicata dietro feature flag default-off.
