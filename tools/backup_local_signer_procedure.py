...
REQUIRED_PATHS = (
    ...
    RequiredPath("deploy/hetzner/Caddyfile"),
    ...
    RequiredPath("tests/test_local_signer_ai_cache.py"),
    RequiredPath("tests/test_local_signer_installer_atomic.py"),
    RequiredPath("tests/test_firma_pkcs11.py"),
    RequiredPath("tests/test_impostazioni_pec_local_signer_react.py"),
    RequiredPath("tests/test_impostazioni_firma_local_signer_versione_react.py"),
    RequiredPath("tests/test_react_shell.py"),
    RequiredPath("tests/test_conformita_pst.py"),
    RequiredPath("tests/test_codici_oggetto_pst_catalog.py"),
    RequiredPath("tests/test_import_pst_xsd_codici_oggetto.py"),
    RequiredPath("tests/test_pst_catalog.py"),
    RequiredPath("tests/test_pst_original_presidio_runtime.py"),
    RequiredPath("tests/test_pst_services.py"),
    RequiredPath("tests/test_pst_xsd_catalog_importer.py"),
    RequiredPath("tests/test_polisweb.py"),
    RequiredPath("tests/test_polisweb_cerca_rg.py"),
    RequiredPath("tests/test_polisweb_diff.py"),
    RequiredPath("tests/test_polisweb_eventi.py"),
    RequiredPath("tests/test_polisweb_fascicolo_sync.py"),
    RequiredPath("tests/test_polisweb_scadenze_registri.py"),
    RequiredPath("tests/test_polisweb_sync_job.py"),
    RequiredPath("tests/test_deposito.py"),
    RequiredPath("tests/test_canali_telematici_deposito.py"),
    RequiredPath("tests/test_deposito_anagrafica_ministeriale.py"),
    RequiredPath("tests/test_deposito_compatibilita.py"),
    RequiredPath("tests/test_deposito_destination_tables.py"),
    RequiredPath("tests/test_deposito_guidato.py"),
    RequiredPath("tests/test_deposito_route_helpers.py"),
    RequiredPath("tests/test_deposito_server_dry_run_audit.py"),
    RequiredPath("tests/test_deposito_telematico_catalogo.py"),
    RequiredPath("tests/test_profilo_deposito.py"),
    RequiredPath("tests/test_regia_deposito_receipts.py"),
    RequiredPath("tests/test_simulazione_deposito.py"),
    RequiredPath("tests/test_notifiche_legali.py"),
    RequiredPath("tests/test_notifiche_legali_preview_ui.py"),
...
def build_backup(output: Path) -> Path:
    ...
    manifest = {
        ...
        "voci_installazione_richieste": [item.path for item in INSTALLED_REQUIRED_PATHS],
        "file": copied,
    }
