...
def default_scheduler_templates(config: dict[str, Any] | None = None) -> tuple[SchedulerTemplate, ...]:
    ...
    builtins = (
        ...
        SchedulerTemplate("fascicoli_document_economic_presidio", "Presidio fascicoli ed economia", "Fascicoli", "Legge solo documenti nuovi o modificati, classifica evidenze processuali/economiche, salva pagamenti e stato pratica nel DB e lascia la UI veloce.", "cron", "", "13-58/15", built_in=True),
