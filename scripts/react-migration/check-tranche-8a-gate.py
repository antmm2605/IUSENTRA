...
REPORT = ROOT / "artifacts/react-migration/tranche-8a-gate.md"
...
def main() -> int:
    results: list[dict] = []
    with tempfile.TemporaryDirectory(prefix="iusentra-tranche-8a-", ignore_cleanup_errors=True) as tmp:
        tmp_path = Path(tmp)
