...
- Baseline operative attuali da non peggiorare senza la procedura sopra: Gate anti-regressione contratti CI `tests/test_ci_no_regression_contract.py` = 100%; coverage critica aggregata locale verificata in questa tranche >= 71,49% sul blocco `Coverage moduli critici`.
