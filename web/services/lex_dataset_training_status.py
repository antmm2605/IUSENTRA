    ...
    *,
    ...
    cards = [
        ...
        _card(
            ...
            "Le coppie domanda/risposta non entrano nel dataset finale senza revisione umana.",
        ...
        _card(
            ...
            "Formato Alpaca pronto solo con esempi approvati e senza addestramento automatico.",
        ...
        _card(
            ...
            "Formato ShareGPT disponibile solo dopo approvazione degli esempi.",
        ...
        _card(
            ...
            "Modello locale",
            "Percorso manuale",
            "LLaMA Factory e Ollama restano manuali: IUSENTRA prepara i file, non avvia addestramento.",
            "info",
            value="manuale",
    ...
    return {
        ...
        "schedule": {
            ...
            "label": "Dataset Lex notturno",
            "family": "Lex AI",
            "time": "01:45",
            "message": "Preparazione automatica da Pianificazioni Superadmin, senza addestramento automatico.",
        },
        "errors": errors,
        ...
        "privacy": {
            ...
            "message": "Nessun dato viene inviato fuori dallo studio e nessun addestramento parte automaticamente.",
        },
    }
